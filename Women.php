...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $command = escapeshellcmd("python predict.py $pregnancies $glucose $bp $skin_thickness $insulin $bmi $dpf $age");
...
<head>
    ...
    <script type="text/javascript">
		function showPopup(infoType) {
			...
			var popupWindow = window.open(
				popupURL,
				'popUpWindow',
				'height=300, width=400, left=10, top=10, resizable=no, scrollbars=yes, toolbar=no, menubar=no, location=no, directories=no, status=no'
			);
			return false;
		}
    </script>
    ...
    function showPopup2() {
        ...
        var popupWindow = window.open(
            popupURL,
            'popUpWindow', 
            'height=500, width=800, left=10, top=10, resizable=no, scrollbars=yes, toolbar=no, menubar=no, location=no, directories=no, status=no'
        );
...
<main>
    <div class="jumbotron">
        <h1>Women Diabetes Forecast</h1>
        <img src="img/cropped_woman_group.PNG" width="1000px" alt="Woman Diabetes">
        <p class="lead">
		This Woman diabetes risk prediction tool estimates the potential risk of woman diabetes using Artificial Neural Network (ANN).
		<br/>
		Disclaimer: Use this woman diabetes prediction tool for information purposes only; it’s not a substitute for professional medical advice, diagnosis, or treatment.
		</p>
			...
			<div class="card h-100">
				...
				<form action="Women.php" method="post">
					<table >
						...
						<tr>
							<td><img src="img/pregnancies.PNG" width="40" onclick="showPopup('pregnancies');" alt="Reference"></td></td>
							...
							<td style="padding: 10px;">Pregnancy</td>
							<td><input type="text" name="pregnancies" placeholder="Number of times pregnant"></td>
						...
						<tr>
							...
							<td><input type="text" name="skin_thickness" placeholder="mm"></td>
							<!--<td><img src="img/reference.PNG" width="30" onclick="showPopup();" alt="Reference"></td>-->
						</tr>
						<tr>
							...
							<td><input type="text" name="insulin" placeholder="80"></td>
							<!--<td><img src="img/reference.PNG" width="30" onclick="showPopup();" alt="Reference"></td>-->
						</tr>
						<tr>
							...
							<td><input type="text" name="bmi" placeholder="32.0 kg/m^2"></td>
							<!--<td><img src="img/reference.PNG" width="30" onclick="showPopup();" alt="Reference"></td>-->
						</tr>
						<tr>
							...
							<td><input type="text" placeholder="0.472" name="dpf"></td>
